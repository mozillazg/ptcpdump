...
CMD="$1"
APP="${SCRIPT_DIR}/gohttpapp/gohttpapp_stripped_pie"
FILE_PREFIX="/tmp/ptcpdump"
KEYLOG_PATH="${FILE_PREFIX}_keylog_stripped_pie.txt"
PCAP_FILE="${FILE_PREFIX}_keylog_stripped_pie.pcap"
PCAPNG_FILE="${FILE_PREFIX}_keylog_stripped_pie.pcapng"
